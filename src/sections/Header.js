                    ...
                    <div className="col-12 col-lg-3">
                        <div className="header-content bg-dark h-100 pt-6 pe-6 pb-6">
                            <a href="index.html" className="navbar-brand d-inline-flex pb-5 wow fadeInUp" data-wow-delay="0.1s">
                                <h1 className="display-6 text-white mb-0">{ profile.name }</h1>
                            </a>
                            <div className="text-start d-flex flex-column justify-content-center wow fadeInUp" data-wow-delay="0.3s">
                                <p className="text-white sub-title">👋 Hello I'm Mezbah</p>
                                <h1 className="display-6 text-white mb-0">Creative Designer Based in USA</h1>
                            </div>
                        </div>
                    </div>
