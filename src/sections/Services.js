                                    ...
                                    <div className="service-item p-4 wow fadeInUp" data-wow-delay="0.1s">
                                        <div className="row g-4 align-items-center">
                                            ...
                                            <div className="col-xl-3">
                                                <a href="#" className="h4 mb-0">Creative Design</a>
                                            </div>
                                            <div className="col-xl-4">
                                                <p className="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis laboriosam repudiandae
                                                </p>
                                            </div>
                                            <div className="col-xl-3">
                                                <p><i className="fa fa-check me-2"></i> UI/UX Design</p>
                                                <p><i className="fa fa-check me-2"></i> Research</p>
                                                <p className="mb-0"><i className="fa fa-check me-2"></i> Mobile App</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="service-item p-4 wow fadeInUp" data-wow-delay="0.3s">
                                        <div className="row g-4 align-items-center">
                                            ...
                                            <div className="col-xl-3">
                                                <a href="#" className="h4 mb-0">Web Developm</a>
                                            </div>
                                            <div className="col-xl-4">
                                                <p className="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis laboriosam repudiandae
                                                </p>
                                ...
                                <div className="col-12">
                                    <div className="service-item p-4 wow fadeInUp" data-wow-delay="0.5s">
                                        <div className="row g-4 align-items-center">
                                            ...
                                            <div className="col-xl-3">
                                                <a href="#" className="h4 mb-0">Mobile Application</a>
                                            </div>
                                            <div className="col-xl-4">
                                                <p className="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis laboriosam repudiandae
                                                </p>
